"""
Zadanie operacje na rachunku bankowym, skorzystaj z skróconych operatorów przypisania
z operacją matematyczną np: += -= *= /= itd.
...
6) Bank zorientował się że powstał błąd i cofa ostatnie transakcje.
    Dodaj do salda 4000, podziel je przez 3 i dopiero teraz odejmij 4000
